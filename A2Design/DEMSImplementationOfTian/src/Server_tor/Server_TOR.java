...
import Server_mtl.config_MTL;

public class Server_TOR extends Server_interfacePOA{
	// database of tor
	...
	public Server_TOR() throws Exception {
		super();
	}
	...
	public synchronized String addEvent(String eventID, String eventType, int bookingCapacity) {
		...
		if (s.contains("successfully")) {
			config_TOR.LOGGER
					.info(config_TOR.MANAGER_ID + " add Event Record: " + getEventName(eventType) + " " + eventID + " "
							+ bookingCapacity + ". Request successfully completed. " + " Server response: " + s);
		} else {
			config_TOR.LOGGER.info(config_TOR.MANAGER_ID + " add Event Record: " + getEventName(eventType) + " "
	...
	public synchronized String removeEvent(String eventID, String eventType) {
		...
		if (s.contains("successfully")) {
			...
			config_TOR.LOGGER.info(config_TOR.MANAGER_ID + " remove Event Record: " + getEventName(eventType) + " "
	...
	public String listEventAvailability(String eventType) {
		...
		s = s.trim();
		config_TOR.LOGGER.info(config_TOR.MANAGER_ID + " list event availability: " + getEventName(eventType)
				+ ". Request successfully completed. " + " Server response: " + s);
		return s;
	}
	...
	public static void main(String[] args) {
		try {
			...
			Server_TOR addobj = new Server_TOR();
			addobj.setORB(orb);
	...
	public static void initLogger() {
		try {
			...
			config_TOR.FH = new FileHandler("Server_Side_Log/" + config_TOR.SERVER_NAME + ".log", true);

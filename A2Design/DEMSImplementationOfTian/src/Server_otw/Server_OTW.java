...
public class Server_OTW extends Server_interfacePOA {
	...
	public Server_OTW() throws Exception {
		super();
	}
	...
	public synchronized String addEvent(String eventID, String eventType, int bookingCapacity) {
		...
		if (s.contains("successfully")) {
			config_OTW.LOGGER
					.info(config_OTW.MANAGER_ID + " add Event Record: " + getEventName(eventType) + " " + eventID + " "
							+ bookingCapacity + ". Request successfully completed. " + " Server response: " + s);
		} else {
			config_OTW.LOGGER.info(config_OTW.MANAGER_ID + " add Event Record: " + getEventName(eventType) + " "
	...
	public synchronized String removeEvent(String eventID, String eventType) {
		...
		if (s.contains("successfully")) {
			...
			config_OTW.LOGGER.info(config_OTW.MANAGER_ID + " remove Event Record: " + getEventName(eventType) + " "
	...
	public String listEventAvailability(String eventType) {
		...
		s = s.trim();
		config_OTW.LOGGER.info(config_OTW.MANAGER_ID + " list event availability: " + getEventName(eventType)
				+ ". Request successfully completed. " + " Server response: " + s);
		return s;
	}
	...
	public static void main(String[] args) {
		try {
			...
			Server_OTW addobj = new Server_OTW();
			addobj.setORB(orb);
	...
	public static void initLogger() {
		try {
			...
			config_OTW.FH = new FileHandler("Server_Side_Log/" + config_OTW.SERVER_NAME + ".log", true);

 ...
 * @Modified by:
 */
public class OTWImplementationClass extends CommonInterfacePOA {

    public static LogRecorder otwLogRecorder;
    //initial port number
    ...
    public OTWImplementationClass() throws Exception {
        super();
        otwLogRecorder = new LogRecorder(2);
        ...
        this.tsList = tsList;
//        EventDetails ed1 = new EventDetails(4);
//        this.semList.put("OTWM180619", ed1);
    }
    ...
    public void addEventHelper(
        ...
        EventDetails cur;
        try {
            otwLogRecorder.writeLog(otwLogRecorder.paraConstructor(userID,
    ...
    public int bookEvent(
        ...
        if (tripleCheck == -1) {
            ...
            if (eventID.startsWith("OTW")) {
                ...
                rs = Integer.parseInt(sendRequest(mtlUdpPort, 2, customerID,
            ...
            try {
                if (rs == 0)
                    otwLogRecorder.writeLog(otwLogRecorder.paraConstructor("",
    ...
    public int cancelEvent(
        ...
        if (eventID.startsWith("OTW")) {
            ...
            rs = Integer.parseInt(sendRequest(mtlUdpPort, 3, customerID,
                    eventType, eventID).trim());
        } else if (eventID.startsWith("TOR")) {
    ...
    public int swapEvent(
        ...
        if (checkRs == -3) {
            try {
                otwLogRecorder.writeLog(
                        otwLogRecorder.paraConstructor("", customerID,
    ...
    private String sendRequest(
            int serverPort, int requestType,
            String userID, int eventType, String eventID) {
        String rs = "";
        ...
        try {
            ...
            DatagramPacket request = new DatagramPacket(message,
                    requestStr.length(), aHost, serverPort);//request
            // packet ready
            ...
            DatagramPacket reply = new DatagramPacket(buffer,
                    buffer.length);//reply packet ready but not populated.

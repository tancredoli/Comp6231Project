 ...
 * @Modified by:
 */
public class TORImplementationClass extends CommonInterfacePOA {
    ...
    public TORImplementationClass() throws Exception {
        ...
        this.tsList = tsList;
//        EventDetails ed1 = new EventDetails(5);
//        this.tsList.put("TORE150619", ed1);
    ...
    public void addEventHelper(
        ...
        EventDetails cur;
        try {
            torLogRecorder.writeLog(torLogRecorder.paraConstructor(userID,
    ...
    public int bookEvent(
        ...
        if (tripleCheck == -1) {
            ...
            try {
                if (rs == 0)
                    torLogRecorder.writeLog(torLogRecorder.paraConstructor("",
    ...
    public int swapEvent(
        ...
        if (checkRs == -3) {
            try {
                torLogRecorder.writeLog(
                        torLogRecorder.paraConstructor("", customerID,

...
/**
* ServerInterface/_CommonInterfaceStub.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from C:/Project/Comp6231A2/src/ServerInterface.idl
* Saturday, July 6, 2019 4:09:45 o'clock PM EDT
*/

public class _CommonInterfaceStub extends org.omg.CORBA.portable.ObjectImpl implements ServerInterface.CommonInterface
{
  ...
  public String getBookedList (String eventID, int eventType)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getBookedList", true);
                $out.write_string (eventID);
                $out.write_long (eventType);
                $in = _invoke ($out);
                String $result = $in.read_string ();
                ...
                return getBookedList (eventID, eventType        );
            } finally {
                _releaseReply ($in);
            }
  } // getBookedList

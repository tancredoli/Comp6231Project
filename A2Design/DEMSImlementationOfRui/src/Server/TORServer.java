...
import ImplementInterface.TORImplementationClass;
 ...
 * @Author: Rui
 * @Description:
 * @Date: Created in 5:25 PM 2019-07-06
 * @Modified by:
 */
public class TORServer {
    ...
    private static void handleRequest(TORImplementationClass obj) {
        DatagramSocket aSocket = null;
        try {
            String result = "";
            aSocket = new DatagramSocket(9102);
    ...
    public static void main(String[] args) {
        try {
            ...
            TORImplementationClass torObj = new TORImplementationClass();
            torObj.setORB(orb);
            ...
            System.out.println("TORServer is Started..........");
            Runnable task = () -> {
                handleRequest(torObj);
            };
        ...
        System.out.println("TORServer Exiting ...");
    }
